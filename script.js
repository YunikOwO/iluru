...
const personnages = [
  ...
  },
  {
    ...
    portrait_m: "C’est quelqu’un qui est très sûr de lui. Ce qu’il aime, c’est se battre contre des adversaires puissants, et aime le combat en général. Il sait qu’il est puissant et n’hésite pas à s’imposer quand il veut faire comprendre que quelque chose ne lui plait pas. Il n’aime pas perdre mais se fiche aussi de gagner, il souhaite juste se battre et profiter de la vie comme lui l’entend. Cela dit, malgré sa grande confiance en lui, il a conscience de ses faiblesses et s'entraîne afin de devenir meilleur. Il peut aussi parfois se montrer menaçant, mais aussi narquois.. Il est assez proche d’Omoda, qui a une grande confiance en lui. Egalement, il est assez doué pour jauger ses adversaires, et est plus clairvoyant qu’on ne le croit. Enfin c’est quelqu’un qui sait être sérieux mais aussi rigoler avec ses amis (même s’il n’en a pas beaucoup)",
