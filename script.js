...
const personnages = [
  {
    ...
    sexe: "Mâle",
    age: 5130,
    portrait_p: "Sous sa forme cachée, il s’agit d’un loup gris foncé, tirant presque sur le noir, et blanc avec des touches de vert. Il possède des yeux en fente de couleur différente : son œil gauche est rouge et son œil droit est vert. Langue couleur chair (classique) - Intérieur de la bouche pareil. Crinière aspect ‘naturel’, 1m83. Sur son œil droit, autour de sa pupille, il a quatre symboles en forme de triangle. Particularité, lorsque ses deux yeux sont visibles, sa vision atteint 360°. Il est extrêmement fort et rapide. Sous son identité “Anubis”, il se bat avec une lance ou simplement avec ses poings et a des pouvoirs. Il possède également une lentille qui rend son œil gauche vert. ",
    portrait_m: "Il fait assez froid en général, mais peut se montrer cruel et sadique. Lors des combats, il cherche généralement à tuer son adversaire. De plus, c'est quelqu’un qui est avide de pouvoir, qui cherchera à le conserver. Cependant, c’est aussi quelqu’un de très intelligent, qui sait cacher son côté meurtrier, et qui a réussi grâce à divers stratagèmes à se hisser jusqu’au pouvoir, et parvient à se cacher sous diverses identités. Son plus grand but dans la vie semble d’exterminer les krisopals, et plus particulièrement Omoda. Enfin, il s’intéressera à quiconque est capable de rivaliser ou de lui tenir tête.",
    background: "A venir",
